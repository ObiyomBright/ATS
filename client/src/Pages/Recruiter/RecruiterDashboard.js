...
export const RecruiterDashboard = () => {
    ...
    //                     // const response = await fetch(`http://localhost:5000/jobs/all-jobs/${recruiter.jobID}`)
    ...
    //         try {
    //             const reponse = await fetch(`http://localhost:5000/recruiter/all-recruiter`)
    ...
    useEffect(() => {
        const fetchRecruiterData = async () => {
            try {
                const response = await fetch(`http://localhost:5000/recruiter/all-recruiter`);
                if (!response.ok) {
    ...
    useEffect(() => {
        if (recruiter && recruiter.jobID) {
            ...
            const fetchJobsData = async () => {
                try {
                    //       const response = await fetch(`http://localhost:5000/jobs/current-jobs/${recruiter.jobID}`);
                    //       const data = await response.json();
                    //       setJobs(data);
